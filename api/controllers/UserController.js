 ...
 module.exports = {
 	...
 	create: function(req, res, next) {
 		...
 		var userObj = { //on passe les parametres en objet pour la securité
 			...
 			departement: req.param('departement'),
 		...
 		User.create(userObj, function userCreated(err, user) {
 			...
 			user.save(function(err, user) {
 				...
 				res.redirect('/user/addcompany/'+req.session.User.id); ////user.id
 			});
 	...
 	companydirectory: function(req, res, next) {
 		...
 		Companytarget.find(function foundCompany(err, companies) {
 			if (err) return next(err);
 			res.view({
 				companies: companies
 			});
   ...
   //},
 	...
 	companyedit: function(req, res, next) {
